...
<div class="container py-1">
    ...
    <body class="bg-light">
        ...
        <div class="pricing-header p-2 pb-md-2 mx-auto text-center">
            ...
            <p class="fs-5 text-muted">This is the Admin Portal for CourseLink, the Training Enrollment Portal! At the top of the page you can view the users as well as edit their details, delete users and obviously, add new users! In the Course Management view you can view all courses, the users enrolled on a course and also adding and removing users from the course.
            </p>
...
<div class="container mt-4 p-5 shadow-lg rounded bg-white ">
